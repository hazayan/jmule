...
public class TransfersTab extends MainTab {
	...
	public TransfersTab(Composite ctab,JMuleCore core) {
		super(ctab,"Transfers");

		_core = core;
		tab_content.setLayout(new FormLayout());
		
		download_panel = new Composite(tab_content,SWT.NONE);
		upload_panel = new Composite(tab_content,SWT.NONE);
		
		SashControl.createHorizontalSash(50, 50, tab_content, download_panel, upload_panel);
