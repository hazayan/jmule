 ...
 */
public class JMPeerSecureIdentificationSP implements ScannedPacket {

	private byte[] challenge;
	private boolean isPublicKeyNeeded;
	
	public JMPeerSecureIdentificationSP(byte[] challenge, boolean isPublicKeyNeeded) {
		super();
