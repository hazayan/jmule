 ...
 */
public class JMServerFoundSourceSP extends LinkedList<Peer> implements ScannedPacket{

	private FileHash fileHash;
	
	public JMServerFoundSourceSP(FileHash fileHash) {
		super();
		this.fileHash = fileHash;
	}
	
	public int getPacketCommand() {
		return PACKET_SRVFOUNDSOURCES;
	}
