 ...
 * Last changed by $$Author: javajox $$ on $$Date: 2008/07/31 16:42:39 $$
 */
public class JMPeerFileHashSetAnswerSP implements ScannedPacket{

	private PartHashSet partHashSet;
	
	public JMPeerFileHashSetAnswerSP(PartHashSet partHashSet) {
		this.partHashSet = partHashSet;
	}

	public int getPacketCommand() {
		return OP_HASHSETANSWER;
	}
	...
	public void setPartHashSet(PartHashSet partHashSet) {
		this.partHashSet = partHashSet;
	}
