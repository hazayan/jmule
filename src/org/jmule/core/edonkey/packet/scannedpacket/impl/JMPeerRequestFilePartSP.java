 ...
 */
public class JMPeerRequestFilePartSP extends LinkedList<FileChunkRequest> implements ScannedPacket{

	private FileHash fileHash;
	
	public JMPeerRequestFilePartSP(FileHash fileHash) {
		super();
		this.fileHash = fileHash;
	}

	public int getPacketCommand() {
		return OP_REQUESTPARTS;
	}
