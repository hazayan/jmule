 ...
 */
public class JMPeerFileRequestAnswerSP implements ScannedPacket {

	private FileHash fileHash;
	private String fileName;
	
	public JMPeerFileRequestAnswerSP(FileHash fileHash, String fileName	) {
		this.fileHash = fileHash;
		this.fileName = fileName;
	}
	
	public int getPacketCommand() {
		return OP_FILEREQANSWER;
	}
