 ...
 * Last changed by $$Author: javajox $$ on $$Date: 2008/07/31 16:42:34 $$
 */
public class JMPeerFileRequestSP implements ScannedPacket {

	private FileHash fileHash;
	
	public JMPeerFileRequestSP(FileHash fileHash) {
		super();
		this.fileHash = fileHash;
	}

	public int getPacketCommand() {
		return OP_FILEREQUEST;
	}
