 ...
 * Last changed by $$Author: javajox $$ on $$Date: 2008/07/31 16:42:33 $$
 */
public class JMPeerFileNotFoundSP  implements ScannedPacket{

	private FileHash fileHash;
	
	public JMPeerFileNotFoundSP(FileHash fileHash) {
		super();
		this.fileHash = fileHash;
	}

	public int getPacketCommand() {
		return OP_FILEREQANSNOFILE;
	}
